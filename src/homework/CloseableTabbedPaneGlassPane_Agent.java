 ...
 * @author pwankhed
 */
public class CloseableTabbedPaneGlassPane_Agent extends JPanel {
	...
	public CloseableTabbedPaneGlassPane_Agent(JTabbedPane tabbedPane) {
		super();
		...
		button.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/pw/sherlock/resources/icons8-delete-16_1.png"))); // NOI18N
		...
		//button.setLocation(WIDTH, WIDTH);
	}
	...
	public void paintComponent(Graphics g) {
		...
		for (int i = 0; i < tabbedPane.getTabCount(); i++) {
			...
			buttonRect.translate(glassPt.x + 4, glassPt.y);
