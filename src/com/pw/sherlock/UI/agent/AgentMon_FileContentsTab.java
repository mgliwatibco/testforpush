 ...
 * @author pwankhed
 */
public class AgentMon_FileContentsTab extends javax.swing.JPanel {
	
	OshiMiscFuncs oshiObj;
	private final Logger AgentMonFiletab = Logger.getLogger(AgentMon_FileContentsTab.class);
	
	public AgentMon_FileContentsTab(String fileName) {
		initComponents();
		try {
			SwingUtilities.invokeLater(new Runnable() {
				@Override
				public void run() {
					oshiObj = new OshiMiscFuncs();
					...
					String pathSeparator = oshiObj.getPathSeparator();
					String file2Read = Home.master_tibcoHome + pathSeparator  + "bw" + pathSeparator 
							+ Home.master_tibcoBWVersion.substring(Home.master_tibcoBWVersion.indexOf("6."), Home.master_tibcoBWVersion.indexOf("6.") + 3)
							+ pathSeparator + "bin" + pathSeparator + fileName;
									
					fileContent_TextArea.setText(SherlockUtils.readFile(file2Read));
					fileNameLbl.setText("<html><b>File Location: </b>" + file2Read + "</html>");
				}
			});
		} catch (Exception ex) {
			AgentMonFiletab.error("Exception occured while reading the file: '" + fileName + "' requested by ' AgentMon_FileContentsTab()" 
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(fileNameLbl, javax.swing.GroupLayout.PREFERRED_SIZE, 843, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(fileNameLbl, javax.swing.GroupLayout.PREFERRED_SIZE, 18, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void closeTdTabActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_closeTdTabActionPerformed
		...
		if (fileNameLbl.getText().contains("-logback.xml")){
			AgentMon_BasePane.agentLogbackSwitch.setSelected(false);
		}else{
		AgentMon_BasePane.agentTraSwitch.setSelected(false);
		}
